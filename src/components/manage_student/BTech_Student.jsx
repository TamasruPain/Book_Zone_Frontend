...
const BTech_Students = () => {
  ...
  useEffect(() => {
    axios.get("http://localhost:7777/student/btech_students")
  ...
  const filteredStudents = btechStudents.filter(student =>
      ...
      <div className='justify-content-center align-items-center'>
        <div className='rounded p-3'>
          ...
          <div align='center' className='my-3'>
            <h5>All Registered B.Tech Students</h5>
            ...
            <Link to='/btech_students' className="btn btn-warning mx-2">B.Tech</Link>
