...
const MBA_Students = () => {
  ...
  const [mbaStudents, setMBAStudents] = useState([]);
  const [searchTerm, setSearchTerm] = useState("");
  const navigate = useNavigate()

  useEffect(() => {
    axios.get("https://book-zone-mern-app.onrender.com/student/mba_students")
      .then(result => setMBAStudents(result.data))
  ...
  const filteredStudents = mbaStudents.filter(student =>
    ...
    <div>
      <div className='justify-content-center align-items-center'>
        <div className='rounded p-3'>
          ...
          <div align='center' >
            <h5>All Registered MBA Students</h5>
            ...
            <Link to='/mtech_students' className="btn btn-outline-secondary mx-2">M.Tech</Link>
            <Link to='/bba_students' className="btn btn-outline-secondary mx-2">BBA</Link>
            <Link to='/mba_students' className="btn btn-warning mx-2">MBA</Link>
          </div>
