...
const BBA_Students = () => {
  ...
  const [bbaStudents, setBBAStudents] = useState([]);
  const [searchTerm, setSearchTerm] = useState("");
  // const navigate = useNavigate()

  useEffect(() => {
    axios.get("http://localhost:7777/student/bba_students")
  ...
  const filteredStudents = bbaStudents.filter(student =>
      ...
      <div className='justify-content-center align-items-center'>
        <div className='rounded p-3'>
          ...
          <div align='center' className='my-3'>
            ...
            <Link to='/bba_students' className="btn btn-warning mx-2">BBA</Link>
