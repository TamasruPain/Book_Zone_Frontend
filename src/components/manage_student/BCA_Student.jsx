...
const BCA_Students = () => {
  ...
  useEffect(() => {
    axios.get("https://book-zone-mern-app.onrender.com/student/bca_students")
      .then(result => setBCAStudents(result.data))
  ...
  const filteredStudents = bcaStudents.filter(student =>
      ...
      <div className='justify-content-center align-items-center'>
        <div className='rounded p-3'>
          ...
          <div align='center' className='my-3'>
            <h5>All Registered BCA Students</h5>

            <Link to='/all_students' className="btn btn-secondary mx-2">All Students</Link>
            <Link to='/bca_students' className="btn btn-warning mx-2">BCA </Link>
