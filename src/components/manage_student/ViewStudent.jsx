    ...
    <div className='d-flex justify-content-center align-items-center' style={{ height: '600px' }} >
      <div className='form-container card p-2' style={{ height: '580px', width: '440px' }} >
        <div className='row p-3'>
          ...
          <div>
            <Link to={`/update_student/${student._id}`} className='btn btn-outline-info my-4 mx-2'>Update</Link>
            <button type='button' className='btn btn-outline-danger my-4 mx-2' onClick={handleDelete}>Delete</button>
          </div>
        </div>
      </div>
    </div>
