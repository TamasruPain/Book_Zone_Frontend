...
const Books_MBA = () => {
  ...
  const [mbaBooks, setMbaBooks] = useState([]);
  const [searchTerm, setSearchTerm] = useState("");
  useEffect(() => {
    axios.get("https://book-zone-mern-app.onrender.com/book/mba_books")
      .then(result => setMbaBooks(result.data))
  ...
  const filteredBooks = mbaBooks.filter(book =>
      ...
      <div className='justify-content-center align-items-center'>
        <div className='rounded p-3'>
          ...
          <div align='center' className='my-3'>
            ...
            <Link to='/books_mba' className="btn btn-warning mx-2">MBA</Link>
          </div>
