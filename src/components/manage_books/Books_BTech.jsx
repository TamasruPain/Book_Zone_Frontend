...
const Books_BTech = () => {
  ...
  const [btechBooks, setBtechBooks] = useState([]);
  ...
  useEffect(() => {
    axios.get("https://book-zone-mern-app.onrender.com/book/btech_books")
      .then(result => setBtechBooks(result.data))
  ...
  const filteredBooks = btechBooks.filter(book =>
    ...
    <div>
      <div className='justify-content-center align-items-center'>
        <div className='rounded p-3'>
          <div>
            <button
              onClick={handleDashboard} className='btn btn-dark btn-sm'>
          ...
          <div align='center' className='my-3'>
            ...
            <Link to='/books_btech' className="btn btn-warning mx-2">B.Tech</Link>
