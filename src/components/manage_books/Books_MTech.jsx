...
const Books_MTech = () => {
  ...
  const [mtechBooks, setMtechBooks] = useState([]);
  const [searchTerm, setSearchTerm] = useState("");
  const navigate = useNavigate();

  useEffect(() => {
    axios.get("https://book-zone-backend.onrender.com/book/mtech_books")
  ...
  const filteredBooks = mtechBooks.filter(book =>
      ...
      <div className='justify-content-center align-items-center' id="scrollspyBookTable" data-bs-spy="scroll" data-bs-target="#list-example" data-bs-offset="0" tabIndex="0" style={{ maxHeight: '640px', overflowY: 'scroll' }}>
        <div className='rounded p-3'>
          ...
          <div align='center' className='my-3'>
            ...
            <Link to='/books_mtech' className="btn btn-warning mx-2">M.Tech</Link>
